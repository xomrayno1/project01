package com.tamnc.messaging.listener.kafka;
...
import com.tamnc.domain.ports.input.message.listener.customer.CustomerMessageListener;
import com.tamnc.kafka.consumer.KafkaConsumer;
